...
# Count number of False Negatives at 0.1 IoU

def get_false_negatives(ground_truth, prediction, results, image_name, threshold=0.1):
...
def get_false_positives(ground_truth, prediction, results, image_name, threshold=0.1):

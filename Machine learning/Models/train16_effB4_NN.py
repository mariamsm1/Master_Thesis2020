...
from tensorflow.keras.layers import Dense, Conv2D, Flatten, Input, MaxPooling2D, Activation, BatchNormalization, Concatenate, Dropout, Add, LeakyReLU
...
efnet = efc.EfficientNetB4(input_shape = Image_size , weights = 'imagenet', include_top = False)
...
plt.title("Training loss and Accuracy on EffnetB4")

...
count = 0
#start with round1
path_train = '/home/marmia/snic2020-6-41/Mariam/Mariam_Thesis/Results_Pipelines_Images/Binary_Classifier_data/Objects_split/round1/aug_train'
path_val = '/home/marmia/snic2020-6-41/Mariam/Mariam_Thesis/Results_Pipelines_Images/Binary_Classifier_data/Objects_split/round1/aug_val'
####fix train images
...
y = Dropout(0.5)(y)
y = Dense(64, activation='tanh', name = 'FC2')(y)
y = Dropout(0.5)(y)
...
plt.legend(loc = "best")
plt.savefig('train12_100epochs.png')
